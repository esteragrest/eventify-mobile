export const CAPABILITIES = [
  {
    ...
    //TODO: посмотреть че по картинкам
    icon: require("../../../assets/img/create.svg"),
    color: "#E8FF59",
  },
  {
    id: "002",
    ...
    icon: require("../../../assets/img/filter.svg"),
    color: "#C0A2E2",
  },
  {
    id: "003",
    ...
    icon: require("../../../assets/img/members.png"),
    color: "#E0C9FF",
  },
  {
    id: "004",
    ...
    icon: require("../../../assets/img/notifications.svg"),
    color: "#E8FF59",
  },
];
